...
class User(Base):
    ...
    mfa_recovery_code_hash: Mapped[str | None] = mapped_column(String(255), nullable=True)
    mfa_recovery_code_expires_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
